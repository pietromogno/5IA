 ...
 */
public class VistaAutenticazione extends javax.swing.JFrame {
     ...
     */
    public VistaAutenticazione(BufferedReader in, PrintWriter out) {
        this.in=in;
        this.out=out;
        initComponents();
    }
    ...
    private void btnAccediActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAccediActionPerformed
        try {
            ...
            Logger.getLogger(VistaAutenticazione.class.getName()).log(Level.SEVERE, null, ex);
        }
